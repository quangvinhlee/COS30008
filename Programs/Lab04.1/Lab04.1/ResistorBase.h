...
{
private:
	// converts base value and unit value (object remains unchanged)
	// Example: the value of a register 56000.0 in unitless becomes 56.0kOhm
	...
	void convertUnitValueToBaseValue(const double& aRawValue,
...
protected:
	...
	// setter for base value (used in method convertUnitValueToBaseValue())
