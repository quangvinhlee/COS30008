...
int main()
{
	...
	std::cout << "Vector " << a3 << " . " << b3 << " = " << a3.dot(b3) <<
		std::endl;
	std::cout << "Vector " << a3 << "[0] = " << a3[0] << " <=> " << a3 << ".x() = "
		<< a3.x() << std::endl;
	std::cout << "Vector " << a3 << "[1] = " << a3[1] << " <=> " << a3 << ".y() = "
		<< a3.y() << std::endl;
	std::cout << "Vector " << a3 << "[2] = " << a3[2] << " <=> " << a3 << ".w() = "
		<< a3.w() << std::endl;
	std::cout << "Test 3x3 matrix:" << std::endl;
	Matrix3x3 ma(Vector3D(1.0f, 1.0f), Vector3D(1.0f, 1.0f), Vector3D(1.0f,
		1.0f));
	...
	std::cout << "Scale " << a3 << " by " << 3.2f << " = " << lScale * a3 <<
		std::endl;
	std::cout << "Rotate " << b3 << " by " << 90.0f << " degrees = " << lRotate *
		b3 << std::endl;
